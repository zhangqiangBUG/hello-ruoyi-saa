package com.zhangqiang.project.monitor.job.service;
...
import com.zhangqiang.common.constant.ScheduleConstants;
import com.zhangqiang.common.exception.job.TaskException;
import com.zhangqiang.common.utils.text.Convert;
import com.zhangqiang.project.monitor.job.domain.Job;
import com.zhangqiang.project.monitor.job.mapper.JobMapper;
import com.zhangqiang.project.monitor.job.util.CronUtils;
import com.zhangqiang.project.monitor.job.util.ScheduleUtils;
...
public class JobServiceImpl implements IJobService
{
    ...
    public void init() throws SchedulerException, TaskException
    {
        scheduler.clear();
        Job job0 = new Job();
        job0.setProjectCode(ZhangqiangCloudConfig.getProjectCode());
        List<Job> jobList = jobMapper.selectJobList(job0);
        for (Job job : jobList)
        {
