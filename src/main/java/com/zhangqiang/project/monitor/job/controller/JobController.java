package com.zhangqiang.project.monitor.job.controller;
...
import com.zhangqiang.project.monitor.job.service.IJobService;
...
public class JobController extends BaseController
{
    ...
    {
        startPage();
        job.setTenantCode(ShiroUtils.getSysUser().getTenantCode());
        job.setProjectCode(ZhangqiangCloudConfig.getProjectCode());
