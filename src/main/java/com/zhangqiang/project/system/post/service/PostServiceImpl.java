package com.zhangqiang.project.system.post.service;
...
public class PostServiceImpl implements IPostService
{
    ...
    {
        post.setTenantCode(ShiroUtils.getSysUser().getTenantCode());
    ...
    {
        return postMapper.selectPostAll(ShiroUtils.getSysUser().getTenantCode());
    }
    ...
    public List<Post> selectPostsByUserId(Long userId)
    {
        ...
        List<Post> posts = postMapper.selectPostAll(ShiroUtils.getSysUser().getTenantCode());
        for (Post post : posts)
        {
    ...
    {
        Post p = new Post();
        p.setTenantCode(ShiroUtils.getSysUser().getTenantCode());
        p.setPostName(post.getPostName());
        if(postMapper.selectPostList(p).size()>0){
