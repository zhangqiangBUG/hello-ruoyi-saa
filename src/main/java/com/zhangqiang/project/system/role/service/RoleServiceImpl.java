package com.zhangqiang.project.system.role.service;
...
import com.zhangqiang.project.system.role.domain.RoleDept;
import com.zhangqiang.project.system.role.domain.RoleMenu;
import com.zhangqiang.project.system.role.mapper.RoleDeptMapper;
import com.zhangqiang.project.system.role.mapper.RoleMapper;
import com.zhangqiang.project.system.role.mapper.RoleMenuMapper;
...
public class RoleServiceImpl implements IRoleService
{
    ...
    {
        role.setTenantCode(ShiroUtils.getSysUser().getTenantCode());
    ...
    public boolean deleteRoleById(Long roleId)
    {
        ...
        if("admin.tenant".indexOf(role.getRoleKey())!=-1){
            throw new BusinessException(String.format("管理员角色,不能删除", role.getRoleName()));
        }
    ...
    public String checkRoleKeyUnique(Role role)
    {
        role.setTenantCode(ShiroUtils.getSysUser().getTenantCode());
        Long roleId = StringUtils.isNull(role.getRoleId()) ? -1L : role.getRoleId();
        Role info = roleMapper.checkRoleKeyUnique(role);
        if (StringUtils.isNotNull(info) && info.getRoleId().longValue() != roleId.longValue())
        {
