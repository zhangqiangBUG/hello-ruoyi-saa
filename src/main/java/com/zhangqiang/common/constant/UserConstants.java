...
public class UserConstants
{
    ...
    public static final String TENANT_USER_TYPE = "02";

    /**
     * 默认管理员账号密码
     */
    public static final String TENANT_USER_ADMIN = "admin";
    public static final String TENANT_USER_PASSWORD = "111111";
