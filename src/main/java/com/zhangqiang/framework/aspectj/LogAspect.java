...
import com.zhangqiang.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.zhangqiang.framework.aspectj.lang.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            operLog.setTenantCode(currentUser.getTenantCode());
