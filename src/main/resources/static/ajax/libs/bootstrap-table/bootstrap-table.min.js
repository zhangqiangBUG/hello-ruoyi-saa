...
(function (j) {
    ...
    e.DEFAULTS = {
        ...
        customSearch: j.noop,
        ignoreClickToSelectOn: function (r) {
            return ["A", "I", "BUTTON"].includes(r.tagName)
        },
        customSort: j.noop,
    ...
    e.prototype.initToolbar = function () {
        ...
        if (this.options.showFullscreen) {
            t.push(m('<button class="btn' + m(" btn-%s", this.options.buttonsClass) + m(" btn-%s", this.options.iconSize) + '" type="button" name="fullscreen" aria-label="fullscreen" title="%s">', this.options.formatFullscreen()), m('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.fullscreen), "</button>")
        }
        ...
        if (this.options.showFullscreen) {
            this.$toolbar.find('button[name="fullscreen"]').off("click").on("click", j.proxy(this.toggleFullscreen, this))
        }
        if (this.options.showRefresh) {
    ...
    e.prototype.initBody = function (x) {
        ...
        this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", function (J) {
            ...
            if (J.type === "click" && z.options.clickToSelect && E.clickToSelect && !z.options.ignoreClickToSelectOn(J.target)) {
    ...
    e.prototype.initServer = function (r, w, s) {
        ...
        t = j.extend({}, q(null, this.options.ajaxOptions), {
            ...
            async: this.options.async,// 20200814173847 conmi追加
    ...
    e.prototype.toggleAllColumns = function (s) {
        var r = this;
        j.each(this.columns, function (u, v) {
            r.columns[u].visible = s
        });
        this.initHeader();
        this.initSearch();
        this.initPagination();
